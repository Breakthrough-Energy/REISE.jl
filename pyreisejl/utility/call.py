...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=bool,
        default=True
        help="This boolean determines whether or not to automatically extract the data
        generated by the simulation after the engine has finished running. 
        The extraction process can be memory intensive. This is optional and defaults to True.",
    )
    ...
    if args.extract_data:
        ...
        output_dir = 
        extract_scenario(args.output_dir, args.start_date, args.end_date, scenario_id=args.scenario_id)
