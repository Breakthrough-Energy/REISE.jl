...
The cost of operating generators, fixed costs plus variable costs, which can consist of several power blocks at different costs for each generator.
...
Penalty for load shedding (if any).
...
Penalty for transmission line limit violations, if any.
